import define1 from "./70962b6428dcf2b1@35.js";
import define2 from "./25b74589d994abea@335.js";
import define3 from "./76d3d1a9f5e4d386@399.js";
import define4 from "./6e21cf72e679c4c1@13.js";
...
function _17(free_space_att,station_alt,Earth_alt,sat_lat,sat_lon,Earth_lat,Earth_lon,Frequency_GHz){return(
...
function _44(get_atmospheric_gasses_loss,Apparent_Elevation,surf_water_vapour_density,Earth_Station_Height,Frequency_GHz_multi){return(
...
export default function define(runtime, observer) {
  ...
  main.import("free_space_att", child1);
  main.variable(observer()).define(["free_space_att","station_alt","Earth_alt","sat_lat","sat_lon","Earth_lat","Earth_lon","Frequency_GHz"], _17);
  main.variable(observer()).define(["md"], _18);
  const child2 = runtime.module(define2);
  main.import("get_Beam_spreading_loss", child2);
  ...
  main.import("conv_free_to_app", child5);
  ...
  main.variable(observer()).define(["get_atmospheric_gasses_loss","Apparent_Elevation","surf_water_vapour_density","Earth_Station_Height","Frequency_GHz_multi"], _44);
  return main;
}
