...
function _11(get_atmospheric_params){return(
...
function _13(z){return(
z.reduce((a, b) => a + b, 0)
)}

function _14(spec_att){return(
spec_att
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["p676_a"], _3);
  ...
  main.variable(observer()).define(["spec_att"], _8);
  ...
  main.variable(observer()).define(["get_atmospheric_params"], _11);
  main.variable(observer("z")).define("z", _z);
  main.variable(observer()).define(["z"], _13);
  main.variable(observer()).define(["spec_att"], _14);
  return main;
}
