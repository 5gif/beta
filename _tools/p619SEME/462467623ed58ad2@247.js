import define1 from "./6e21cf72e679c4c1@13.js";
import define2 from "./25b74589d994abea@335.js";
import define3 from "./70962b6428dcf2b1@35.js";
import define4 from "./76d3d1a9f5e4d386@399.js";
...
Inputs.number([0.01, Infinity], {
  value: 10,
  step: 0.01,
  label: "Earth station height (km)"
})
)}
...
function _37(get_atmospheric_gasses_loss,Apparent_Elevation,surf_water_vapour_density,Earth_Station_Height,Frequency_GHz_multi){return(
...
export default function define(runtime, observer) {
  ...
  main.import("conv_free_to_app", child1);
  ...
  main.variable(observer()).define(["get_atmospheric_gasses_loss","Apparent_Elevation","surf_water_vapour_density","Earth_Station_Height","Frequency_GHz_multi"], _37);
  const child2 = runtime.module(define2);
  main.import("get_Beam_spreading_loss", child2);
  main.import("get_atmospheric_gasses_loss", child2);
  const child3 = runtime.module(define3);
  main.import("free_space_att", child3);
